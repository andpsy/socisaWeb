...
namespace ExternalServiceCalls
{
    public partial class Form1 : Form
    {
        ...
        { 
            ...
            {
                int uid = 1;
                string conStr = Properties.Settings.Default["MySQLConnectionString"].ToString();
                /*
                ...
                */
                ...
                s.ClientCredentials.UserName.UserName = Properties.Settings.Default["AllianzWSUser"].ToString(); // "Drift Data";
                s.ClientCredentials.UserName.Password = Properties.Settings.Default["AllianzWSPassword"].ToString();  // "driftdata.1";
